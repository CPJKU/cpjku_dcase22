...
def get_processor_default(n_fft=2048 * 2, sr=44100, log_spec=False, n_mels=256, win_length=None, hop_length=512 * 2,
    ...
    @param log_spec: boolian value to indiciate log_spectorgrams
    ...
    @param resample_only: boolian value indicating that preprocess only does the resampling or creates spectograms
